    ...
    <div>
      <Stack>
        ...
        <Stack horizontal tokens={stackTokens} styles={stackStyles}>
          <Stack {...columnProps}>
            <Dropdown
              label="Insurance BU PRC Classification:"
            ...
            />
            <TextField
              label="Actions/ Conditions/ Comments raised by BU PRC"
          ...
          <Stack {...columnProps}>
            <Dropdown
              label="Insurance BU PRU Outcome:"
            ...
            <PeoplePicker
              context={props.context}
              titleText="Infrustructures area approved by BU PRC"
              personSelectionLimit={3}
              showtooltip={true}
